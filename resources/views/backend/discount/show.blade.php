        ...
        <div class="card">
            <div class="card-header">{{ $datas['title'] }}
                <div class="card-tools">
                    <a href="{{ url('discount/'. $datas['data']->id.'/edit') }}" class="btn btn-warning"><i class="fas fa-edit"></i>
                        Edit</a>
                        <a href="{{ url('discount') }}" class="btn btn-default"><i
            ...
            <div class="card-body table-responsive p-0">
                <div class="card-body table-responsive p-0  mb-5">
                    <dl class="row mx-3">
                        ...
                        <dd class="col-sm-8">: <span class="badge {{ $datas['data']->status == 0 ? 'badge-danger' : 'badge-success' }}">{{ $datas['data']->status == 0 ? 'Dratf' : 'Publish' }}</span></dd>
                        <dt class="col-sm-4">DISCOUNT PERCENT</dt>
                        <dd class="col-sm-8">: {{ $datas['data']->discount_percent }}</dd>
