                            ...
                            <div class="row mx-3">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="job_title" class="form-control" placeholder="Enter contact job title" value="{{ old('job_title') }}">
                                        @error('job_title')
                                            <small class="error text-red">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_office" class="form-control" placeholder="Enter phone office" value="{{ old('phone_office') }}">
                                        @error('phone_office')
                                            <small class="error text-red">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_mobile" class="form-control" placeholder="Enter phone mobile" value="{{ old('phone_mobile') }}">
                                        @error('phone_mobile')
                                            <small class="error text-red">{{ $message }}</small>
                                        @enderror
                                    </div>
