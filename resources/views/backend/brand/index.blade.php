    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">{{ $datas['title'] }}
                <div class="card-tools"> <a href="{{ url('brands/create') }}" class="btn btn-primary"> <i
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu px-2" role="menu" style="">
                                                      <a class="dropdown-item rounded my-1" href="{{ url('brands/'. $item->id.'/edit') }}"> <i class="fas fa-edit "></i> Edit</a>
                                                      <a class="dropdown-item rounded my-1" href="#"
                                                                onclick="event.preventDefault(); document.getElementById('delete-form').submit();">
                                                                <i class=" fas fa-trash"></i> Delete
                                                            </a>
                                                            <form id="delete-form"
                                                                action="{{ url('brands/' . $item->id) }}"
